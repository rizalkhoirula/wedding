  ...
  <div class="container">
    <div class="row">
      <div class="col-md-8 col-md-offset-2 text-center fh5co-heading animate-box">
        <h2>Hello!</h2>
        <h3>14 November 2024 <br> Juragan Restaurant 101 Hotels, Bogor</h3>
    ...
    <div class="couple-wrap animate-box">
      <div class="couple-half">
        ...
        <div class="desc-groom">
          <h3>Mecky Lapian</h3>
          <p>Putra Dari Benny Lapian & Meiske Pandoh yang bernama bla bla</p>
        </div>
      </div>
...
<div id="fh5co-event" class="fh5co-bg" style="background-image:url(images/img_bg_3.jpg);">
    ...
    <div class="container">
        ...
        <center><div class="simply-countdown simply-countdown-one"></div></center> 
        <div class="row">
            <div class="display-t">
                    ...
                    <div class="col-md-10 col-md-offset-1">
                        ...
                        <div class="col-md-6 col-sm-6 text-center">
                            <div class="event-wrap animate-box">
                                ...
                                <p>Rangkaian pesta ini adalah perayaan cinta yang akan kita bagi bersama keluarga dan sahabat. Bergembiralah dan nikmati setiap momen yang penuh keceriaan dan kebahagiaan. Doakan kami menjadi pasangan bahagia.</p>
                            </div>
                        </div>
                    </div>
                </div>
...
function smoothScroll(target, duration) {
  ...
  function scrollStep(timestamp) {
    ...
    let scrollPosition = Math.easeInOutQuad(progress, start, distance, duration);
